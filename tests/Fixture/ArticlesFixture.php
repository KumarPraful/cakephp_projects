...
class ArticlesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'details' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2021-03-16 22:50:12',
                'modified' => '2021-03-16 22:50:12',
            ],
        ];
        parent::init();
    }
